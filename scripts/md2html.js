...
const styles = {
    ...
    minimal: {
        name: '极简白',
        css: `*{margin:0;padding:0;box-sizing:border-box}html,body{height:100%;overflow:hidden}body{font-family:'Inter',sans-serif;background:#fff;color:#000}.slide{height:100vh;display:block;padding:4rem 2rem;overflow:hidden;align-items:center;padding:4rem;text-align:center;opacity:0;position:absolute;width:100%;transition:opacity .4s}.slide.active{opacity:1}.slide h1{font-size:3rem;font-weight:600;letter-spacing:-.02em;margin-bottom:1.5rem}.slide h2{font-size:1.8rem;font-weight:400;color:#666}.slide p,.slide ul,.slide ol{font-size:1.1rem;color:#888;max-width:600px;line-height:1.8}.nav-dot{width:8px;height:8px;border-radius:50%;background:#ddd}.nav-dot.active{background:#000}`,
    ...
    elegant: {
        name: '暗雅',
        css: `*{margin:0;padding:0;box-sizing:border-box}html,body{height:100%;overflow:hidden}body{font-family:'Lato',sans-serif;background:#1a1a1a;color:#f0f0f0}.slide{height:100vh;display:block;padding:4rem 2rem;overflow:hidden;align-items:center;padding:4rem;text-align:center;opacity:0;position:absolute;width:100%;transition:opacity .6s}.slide.active{opacity:1}.slide h1{font-family:'Playfair Display',serif;font-size:3rem;margin-bottom:1.5rem;background:linear-gradient(135deg,#f0f0f0,#c0c0c0);-webkit-background-clip:text;-webkit-text-fill-color:transparent}.slide h2{font-size:1.6rem;color:#a0a0a0;font-weight:300}.slide p,.slide ul,.slide ol{font-size:1.1rem;color:#808080}`,
